...
\documentclass[10pt,letterpaper,sans]{./hadi-style/moderncv}
...
\usepackage[lmargin=0.4in,rmargin=0.6in,tmargin=0.5in,bmargin=0.5in]{geometry}
...
\social[orcid]{0000-0002-8548-1039}
...
% % Custom URL - can be shorted by removing 'c/'
% \social[youtube]{c/jdoeschannel}                   
% % Channel URL (ID-based) - can not be shortened
% \social[youtube]{channel/XXXXXX}                   
% %Legacy username URL    - if jdoe is not already claimed by a Custom URL, can be shortened by removing 'user/'
...
\photo[64pt][2pt]{./images/hadi.jpeg}
